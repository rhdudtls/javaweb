...
insert into guest values(default, '관리자', '방명록 서비스를 시작합니다.', 'ehfrl64@naver.com','https://blog.naver.com/ehfrl64',default,'192.168.50.84');

select * from guest;

delete from guest where name ='고영신';

alter table guest alter name varchar(50);