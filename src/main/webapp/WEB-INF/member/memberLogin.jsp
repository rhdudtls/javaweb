		...
		<div class="modal-content p-4">
		    ...
		    <form name="myform" method="post" action="${ctp}/MemberInputOk.mem" class="was-validated">
			    ...
			    <div class="form-group">
				    ...
				    <input type="password" class="form-control" name="pwd" id="pwd" placeholder="아이디를 입력하세요" required />
			    	<div class="valid-feedback">Ok!!!</div>
			    ...
			    <div class="form-group text-center">
			    	...
			    	<button type="button" onclick="location.href='${ctp}/';" class="btn btn-secondary mr-2">돌아가기</button>
