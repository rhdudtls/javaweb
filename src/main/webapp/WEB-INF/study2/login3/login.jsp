...
<p><br/></p>
<div class="container">
  <form name="myform" method="post" action="${ctp}/database/LoginOk.fa">
    <table class="table table-bordered text-center">
      <tr>
      	<td></td>
        <td class="text-center"><font size="5">로 그 인3</font></td>
        <td class="text-right"><a href="${ctp}/FindId.fa"><span class="badge badge-dark">아이디 찾기</span></a></td>
      </tr>
      <tr>
        <th>아이디</th>
      ...
      <tr>
        <td colspan="3">
          ...
          <input type="button" value="회원가입" onclick="location.href='${ctp}/Join.fa';" class="btn btn-primary mr-4"/>
